...
const OwnerDashboard: React.FC = () => {
  ...
  const platformData = {
    labels: ['Instagram', 'LinkedIn', 'Facebook', 'Twitter', 'Direct'],
    datasets: [
      {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">CareerBoost Owner Dashboard</h1>
              <p className="text-gray-600">Real-time business insights and management</p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow mb-8">
          <div className="border-b">
            <nav className="flex -mb-px">
              {['overview', 'analytics', 'users', 'content', 'system'].map((tab) => (
                <button
                  key={tab}
                ...
                >
                  {tab === 'overview' ? 'Dashboard' : 
                   tab === 'analytics' ? 'Business Analytics' :
                   tab === 'users' ? 'User Management' :
                   tab === 'content' ? 'Content Studio' : 'System Status'}
                </button>
              ))}
            </nav>
          </div>
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="bg-white p-6 rounded-xl shadow border">
                ...
                <div className="mt-2 text-sm text-green-600">+{stats.growthRate}% from last month</div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow border">
                <h3 className="text-lg font-semibold mb-4">Platform Acquisition</h3>
                <div className="h-64">
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { label: 'Customer Acquisition Cost', value: 'R 45.20', change: '-R 2.80' },
                    { label: 'Customer Lifetime Value', value: 'R 890.50', change: '+R 45.30' },
        ...
        {activeTab === 'system' && (
          <div className="bg-white p-6 rounded-xl shadow border">
            <h2 className="text-xl font-semibold mb-6">System Status & Health</h2>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    { component: 'API Server', status: 'healthy', latency: '23ms' },
                    { component: 'File Storage', status: 'healthy', latency: '67ms' },
                    { component: 'Email Service', status: 'degraded', latency: '120ms' },
                    { component: 'Payment Gateway', status: 'healthy', latency: '89ms' }
                  ].map((item, index) => (
                    <div key={index} className="flex justify-between items-center p-3 border rounded">
                      <div>
